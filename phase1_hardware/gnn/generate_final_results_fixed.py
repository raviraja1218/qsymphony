#!/usr/bin/env python
"""Generate final results using the successful model"""
...
plt.subplot(2, 3, 3)
plt.bar(['Loss', 'Constraint', 'Target'], 
        [0.00008, 99.31, 100], 
        color=['red', 'blue', 'green'], alpha=0.7)
plt.axhline(y=0.01, color='red', linestyle='--', alpha=0.5, label='Loss Target')
...
plt.yscale('symlog' if i == 0 else 'linear')
