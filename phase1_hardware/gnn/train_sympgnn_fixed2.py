...
from sympgnn_model import SymplecticGNN, symplectic_loss, count_parameters

# Paths - FIXED: Use the processed subdirectory
...
def main():
    ...
    print("\n🏗️  Creating model...")
    model = SymplecticGNN(
        node_features=4,  # Now all nodes have 4 features
        hidden_dim=128,
        num_layers=5,
        target_dim=4
    ).to(device)
