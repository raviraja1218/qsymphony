#!/usr/bin/env python
"""
STEP 4.1: Generate Synthetic Readout Data - ADVANCED CALIBRATION (FIXED)
...
print("="*60)
print("STEP 4.1: Generate Synthetic Readout Data - ADVANCED CALIBRATION (FIXED)")
print("="*60)
...
class AdvancedReadoutGenerator:
    ...
    def calibrate_qubit(self, qubit_id, target_error, max_iterations=10):
        ...
        noise = self.find_noise_for_target(target_error)
        ...
        for iteration in range(max_iterations):
            ...
            if error > target_error:
                noise *= 1.05  # Increase noise to increase error
            else:
                noise *= 0.95  # Decrease noise to decrease error
