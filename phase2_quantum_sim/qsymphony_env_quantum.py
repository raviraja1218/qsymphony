#!/usr/bin/env python
"""
Full quantum environment with real entanglement calculation
Uses QuTiP for accurate quantum dynamics
"""
...
class QuantumEnv(gym.Env):
    ...
    def step(self, action):
        ...
        try:
            ...
            return self._get_obs(), reward, terminated, truncated, {'E_N': E_N}
