#!/usr/bin/env python
"""
PPO Training with Quantum Environment - WITH PROGRESS BAR
    ...
    def train(self, total_timesteps):
        ...
        while timesteps_so_far < total_timesteps:
            ...
            if episode_num % 5 == 0:
                ...
                steps_per_sec = timesteps_so_far / elapsed
...
def main():
    ...
    print("="*60)
    print("PPO Training with Quantum Environment - WITH PROGRESS BAR")
    print("="*60)
