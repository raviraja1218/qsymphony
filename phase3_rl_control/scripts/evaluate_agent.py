#!/usr/bin/env python
"""
Step 3.4-3.6: Evaluate trained agent and generate paper figures
...
class AgentEvaluator:
    ...
    def run_episode(self, deterministic=True):
        ...
        while not done:
            ...
            # Store
            times.append(obs_np[12])  # time in μs
    ...
    def generate_figure_2a(self, episode_data):
        ...
        print(f"✅ Figure 2a EPS saved: {eps_file}")
        plt.close()
...
def main():
    ...
    print(f"  Episode length: {len(episode_data['times'])} steps")
